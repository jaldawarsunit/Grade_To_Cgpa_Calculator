...
int main()
{
    ...
    int n = 7; // semester wise increase it
    int choice;
    cout << "\nSelect an option:\n\nSemester (SGPA)---> 1-";
    cout << n;
    cout << " (SGPA)\nCGPA           ---> 9\nDSY CGPA       ---> 10\nSem Wise SGPA  ---> 11\nSem Wise CGPA  ---> 12\n\nEnter Choice: ";
...
Semester [7] =  7.70833    Semester [7] =  8.05442
...
Semester [7] =  6.85417    Semester [7] =  6.48639
...
Semester [7] =  7.54167    Semester [7] =  7.41837
...
Semester [7] =  8.20833    Semester [7] =  8.07823
